...
async function generate() {
  ...
  // Construct the prompt using template literals and string interpolation
    ...
    Structure of an argument: 1. Statement. 2. Reasons why the statement is true(as many reasons as possible). 3. Impacts of statement (why the statement is important) 4. Common examples(if available).
